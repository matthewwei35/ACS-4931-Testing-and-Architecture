...
eye_size_check = eye_size > 0.45
iris_size_check = (math.pi*iris_width/2*iris_height/2) / eye_size >= 0.69
eye_height_width_check = eye_height/eye_width >= 0.59

if eye_size_check and iris_size_check and eye_height_width_check:
